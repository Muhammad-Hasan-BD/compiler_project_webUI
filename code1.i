# 0 "compiler_project/src/code1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "compiler_project/src/code1.c"
...
# 2 "compiler_project/src/code1.c" 2
...
# 3 "compiler_project/src/code1.c" 2


# 4 "compiler_project/src/code1.c"
int main() {
    char s[100];
