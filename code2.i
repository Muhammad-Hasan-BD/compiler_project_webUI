# 0 "compiler_project/src/code2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "compiler_project/src/code2.c"
...
# 2 "compiler_project/src/code2.c" 2
...
# 3 "compiler_project/src/code2.c" 2


# 4 "compiler_project/src/code2.c"
int main() {
    char s[100];
    ...
    int i = 0;
    if (s[i] == '_' || 
# 9 "compiler_project/src/code2.c" 3 4
                      ((*__ctype_b_loc ())[(int) ((
# 9 "compiler_project/src/code2.c"
                      s[i]
# 9 "compiler_project/src/code2.c" 3 4
...
# 9 "compiler_project/src/code2.c"
        ...
        while (s[i] != '\0') {
            if (s[i] == '_' || 
# 12 "compiler_project/src/code2.c" 3 4
                              ((*__ctype_b_loc ())[(int) ((
# 12 "compiler_project/src/code2.c"
                              s[i]
# 12 "compiler_project/src/code2.c" 3 4
