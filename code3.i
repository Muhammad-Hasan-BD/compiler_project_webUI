# 0 "compiler_project/src/code3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "compiler_project/src/code3.c"
...
# 2 "compiler_project/src/code3.c" 2


# 3 "compiler_project/src/code3.c"
int main() {
    int count = 0;
    char ch;
    printf("Enter input to count newlines (press Ctrl+D to end):\n");
    while ((ch = getchar()) != 
# 7 "compiler_project/src/code3.c" 3 4
                              (-1)
# 7 "compiler_project/src/code3.c"
                                 ) {
        if (ch == '\n') {
            count++;
        }
